            ...
            <section className="bg-gray-100 py-12">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <p className="text-lg text-center font-bold py-8 text-gray-700 mb-6 animate__animated animate__fadeInUp">
                        "Learn how to donate winter clothes easily: find a campaign, contribute essentials, and help us deliver warmth to communities."
                    </p>
                    
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="card bg-white shadow-lg p-6 text-center border-t-4 border-blue-500 hover:shadow-xl transition-transform transform hover:scale-105 animate__animated animate__fadeInLeft">
                        ...
                        <div className="card bg-white shadow-lg p-6 text-center border-t-4 border-blue-500 hover:shadow-xl transition-transform transform hover:scale-105 animate__animated animate__fadeInUp">
                        ...
                        <div className="card bg-white shadow-lg p-6 text-center border-t-4 border-blue-500 hover:shadow-xl transition-transform transform hover:scale-105 animate__animated animate__fadeInRight">
                            <div className="text-5xl mb-4">🚚</div>
