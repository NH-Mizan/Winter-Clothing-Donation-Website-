        ...
        <div>
            <section className="bg-blue-100 py-12">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    {/* Section Description */}
                    <p className="text-lg font-bold py-8 text-gray-700 mb-6 text-center animate__animated animate__fadeIn">
                        "Discover the Simple Steps to Make a Difference: Find a Campaign, Donate Warm Clothes, Spread Warmth, and Bring Smiles!"
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        {/* Card 4 */}
                        <div className="card bg-white shadow-lg p-6 text-center border-t-4 border-blue-500 hover:shadow-xl transition-transform transform hover:scale-105 animate__animated animate__zoomIn animate__delay-3s">
                            <div className="text-5xl mb-4">📢</div>
